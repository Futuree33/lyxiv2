...
async function migrate() {
    ...
    try {
        await connection.execute('ALTER TABLE `relationship_levels` ADD CONSTRAINT `user_character_idx` UNIQUE(`user_id`,`character_id`)');
...
//# sourceMappingURL=apply-relationship-index.js.map